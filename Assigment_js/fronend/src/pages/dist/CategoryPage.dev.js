...
var CategoryPage = {
  render: function render() {
    var _parseRequestUrl, id, _ref, products, quantitySold, result, _ref2, categories;
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            }).slice(0, 5); // const {id} = parseRequestUrl();
            // console.log(products);

            result = products.filter(function (product) {
              return product.cate_id == id;
