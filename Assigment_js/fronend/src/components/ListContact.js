...
const ListContact = {
    async render(){
        const {data : results} =await ContactAPI.getAll();
        console.log(results);
        return /*html*/`
            <div class="row">
                  ...
                  <table class="table table-striped table-sm">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <a class="btn btn-success btn-edit" href="/#//${category.id}">
                                    <i class="fa fa-edit"></i>
                                    </a>
                                </td>
        
                                <td>
                                    <button class="btn btn-outline-danger rounded-circle m-btn m-btn--icon btn-sm m-btn--icon-only m-btn--pill m-btn--air btn-remove " data-id="${category.id}">
                                        Xoá
    ...
    async afterRender(){
        const btns = await $('#list-contact .btn-remove');
        // console.log(btns);
        btns.forEach(btn => {
            ...
            // console.log(id);
             btn.addEventListener('click', function(){
                ...
                if(question){
                    ...
                    reRender(ListContact, '#list-contact')
                }
            });
        });
    }
