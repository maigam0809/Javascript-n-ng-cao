    ...
    return regeneratorRuntime.async(function render$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.next = 2;
            return regeneratorRuntime.awrap(_contactAPI["default"].getAll());
    ...
    return regeneratorRuntime.async(function afterRender$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            _context2.next = 2;
            return regeneratorRuntime.awrap((0, _untils.$)('#list-contact .btn-remove'));
          ...
          case 2:
            ...
            btns.forEach(function (btn) {
              ...
              btn.addEventListener('click', function () {
                ...
                if (question) {
                  _contactAPI["default"].remove(id);

                  (0, _untils.reRender)(ListContact, '#list-contact');
                }
              });
            });
